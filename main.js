...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,sBAAsB;EACtB,SAAS;EACT,UAAU;EACV,yBAAyB;EACzB,YAAY;AACd;AACA;EACE,iBAAiB;AACnB;AACA;EACE,qBAAqB;AACvB;AACA;EACE,aAAa;EACb,SAAS;AACX;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,SAAS;EACT,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,SAAS;EACT,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,SAAS;EACT,mBAAmB;AACrB;AACA;EACE,gBAAgB;AAClB","sourcesContent":["* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n  background-color: #36393e;\n  color: white;\n}\nbody {\n  min-height: 100vh;\n}\nul {\n  list-style-type: none;\n}\n.content {\n  display: flex;\n  gap: 50px;\n}\n\n.sidebar {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 50px;\n  background-color: #36393e00;\n}\n\n.navigation {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  gap: 20px;\n  align-items: center;\n}\n\n.add-projects {\n  display: flex;\n  flex-direction: column;\n  gap: 15px;\n  align-items: center;\n}\n.add-projects > div {\n  font-size: 0.9em;\n}\n"],"sourceRoot":""}]);
// Exports
...
function initializeAddListeners() {
  ...
  inboxButton.addEventListener('click', () => {
    ...
    (0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.updateAllToDo)();
  })
  ...
  todayButton.addEventListener('click', () => {
    // eslint-disable-next-line no-restricted-globals
    event.preventDefault();
    (0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.updateTodayAllToDo)();
    // function that filters out the project controller array list for todos that contain dueDates = to today and returns that object
    // updateDomFunction that shows the due task objects in the main container
  })
  ...
  // const projectNavButton = document.querySelector()
  ...
  submitTaskButton.addEventListener('submit', () => {
    ...
    const item = (0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.addToDoItemFromDOM)();
    (0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.createTask)(item);
    const projectArray = _ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].projectNameList;
  ...
  submitProjectButton.addEventListener('submit', () => {
    ...
    const project = _ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].newProject(projectNameInput);
    if (projectInput.value === '') {
      return false
    }
    (0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.createProject)(project)
    ;(0,_TaskDOM__WEBPACK_IMPORTED_MODULE_1__.addDropDown)();
...
function createProject(ProjectName) {
  const projectAnchor = document.querySelector('.projectContainer');
...
function addToDoItemFromDOM() {
  ...
  const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(new Date(document.getElementById('date-task').value), 'dd.MM.yyyy');
  const priority = document.getElementById('priority-task').value;
  const project = document.querySelector('.selectProject').value;
  const newToDo = new _ToDo__WEBPACK_IMPORTED_MODULE_1__["default"](title, description, dueDate, priority, project);
  return newToDo;
}
...
function updateAllToDo() {
  const taskDisplay = document.querySelector('.taskDisplay');
  taskDisplay.innerHTML = '';
  const projectManagerArray = _ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].projectNameList;
